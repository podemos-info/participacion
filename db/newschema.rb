...
ActiveRecord::Schema.define(version: 20161005141430) do
  ...
  add_index "ccas", ["author_id", "hidden_at"], name: "index_ccas_on_author_id_and_hidden_at", using: :btree
  add_index "ccas", ["author_id"], name: "index_ccas_on_author_id", using: :btree
  add_index "ccas", ["cached_votes_down"], name: "index_ccas_on_cached_votes_down", using: :btree
  add_index "ccas", ["cached_votes_score"], name: "index_ccas_on_cached_votes_score", using: :btree
  add_index "ccas", ["cached_votes_total"], name: "index_ccas_on_cached_votes_total", using: :btree
  add_index "ccas", ["cached_votes_up"], name: "index_ccas_on_cached_votes_up", using: :btree
  add_index "ccas", ["confidence_score"], name: "index_ccas_on_confidence_score", using: :btree
  add_index "ccas", ["hidden_at"], name: "index_ccas_on_hidden_at", using: :btree
  add_index "ccas", ["hot_score"], name: "index_ccas_on_hot_score", using: :btree
  add_index "ccas", ["title"], name: "index_ccas_on_title", using: :btree
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.integer "ccas_count",                  default: 0
  end

  add_index "tags", ["ccas_count"], name: "index_tags_on_ccas_count", using: :btree
